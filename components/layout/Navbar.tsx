...
import { cn } from "@/lib/utils"; // remove this if you don't have cn — see note below
        ...
        <div ref={navRef}>
          ...
          <div
            ...
            className={[
              ...
              // Mobile: always a pill card
              "rounded-2xl bg-white/95 backdrop-blur-lg border border-gray-200 shadow-lg",
              // Desktop: transparent until scrolled, then pill
              "md:rounded-none md:bg-transparent md:border-0 md:shadow-none md:backdrop-blur-none",
              scrolled
                ? "md:rounded-2xl md:bg-white md:backdrop-blur-lg md:border md:border-gray-200 md:shadow-lg"
                : "",
          ...
          >
            ...
            <div className="hidden lg:flex items-center gap-2">
              <button className="px-4 py-3 text-sm font-medium text-white bg-primary rounded-full hover:bg-gray-700 transition-colors">
                <Link href="#contact">
                  Get a Quote
                </Link>
              </button>
            ...
            <div className="lg:hidden mt-2 rounded-2xl bg-white border border-gray-200 shadow-xl overflow-hidden">
              <nav className="flex flex-col p-3" aria-label="Mobile navigation">
                ...
                <div className="flex gap-2 px-4 pt-3 pb-1 border-t border-gray-100 mt-2">
                  <button className="flex-1 py-2.5 text-sm font-medium text-white rounded-full bg-gray-900 hover:bg-gray-700 transition-colors">
                    <Link href="#contact">
                      Get a Quote
                    </Link>
                  </button>
